...
class TonePlayer:
    ...
    def _find_tone_files(self):
        ...
        possible_locations = [
            # 1. EXACT PATH YOU PROVIDED
            Path.cwd() / 'carfac-SAI/python/src/carfac/reference',
            
            # 2. Relative check (if script is inside src/carfac)
            script_dir / 'reference',
            
            # 3. Check if script is in 'python' folder
            script_dir / 'src/carfac/reference',
            
            # 4. Fallback for common project structures
        ...
        if not tone_files:
            ...
            # Return placeholder paths to prevent crash

...
class DualSAIWithRecording:
    ...
    def _load_audio_file(self):
        ...
        self.set_reference_text('ข้าว')         # For comparison
        self.set_pronunciation_guide('khâao')   # For display
        self.set_translated_text('rice')   # For display
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        default_audio = os.path.join(script_dir, 'reference', 'thai_khaao.mp3')

...
class SAIVisualizationWithWav2Vec2:
    ...
    def _setup_dual_visualization(self):
        ...
        print("DEBUG: Created images and titles")
    ...
    # MOVED OUTSIDE - This method was incorrectly nested inside _setup_dual_visualization
    ...
    def update_visualization(self, frame):
        try:
            ...
            # -------------------------------
            # 3. Update file SAI visualization with speed control
            # -------------------------------
            if self.audio_data is not None:
        ...
        # -------------------------------
        # 5. Return elements for FuncAnimation
        # -------------------------------
        elements_to_return = [
...
# ---------------- Main ----------------
def main():
    parser = argparse.ArgumentParser(description='SAI Visualization + Wav2Vec2 Phoneme Recognition + Similarity Scoring')

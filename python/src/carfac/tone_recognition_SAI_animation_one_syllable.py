...
class ToneIntroductionQuizWithSAI:
    def __init__(self, audio_base_path=None):
        ...
        if audio_base_path is None:
            ...
            possible_paths = [
                script_dir / 'mandarin_audio_one_syllable', 
                script_dir.parent / 'mandarin_audio_one_syllable',
            ...
            if audio_base_path is None:
                audio_base_path = script_dir / 'mandarin_audio_one_syllable'
    ...
    def _launch_next_script(self):
        ...
        specific_path = Path(r"C:\Users\maruk\carfac-SAI\python\src\carfac\tone_recognition_SAI_animation_two_syllable.py")
        
        script_dir = Path(__file__).parent.resolve()
        filename = "tone_recognition_SAI_animation_two_syllable.py"

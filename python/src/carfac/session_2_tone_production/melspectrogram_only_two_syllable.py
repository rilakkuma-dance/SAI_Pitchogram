...
ref = Path("carfac/mandarin_audio_two_syllable")
...
class PracticeSet:
    ...
    def __init__(self, audio_base_path="mandarin_audio_two_syllable"):
        self.all_items = []
...
class SimpleAudioVisualizerWithSAI:
    ...
    def __init__(self, chunk_size=512, sample_rate=16000, sai_width=400, save_dir="recordings", audio_ref_dir="carfac/mandarin_audio_two_syllable"):
...
if __name__ == "__main__":
    visualizer = SimpleAudioVisualizerWithSAI(
        ...
        sai_width=400,
        save_dir="recordings",
        audio_ref_dir="carfac/mandarin_audio_two_syllable" 
    )

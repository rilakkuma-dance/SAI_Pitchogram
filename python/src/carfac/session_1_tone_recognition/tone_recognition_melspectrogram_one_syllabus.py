...
class ToneSpectrogramQuiz:
    ...
    def _launch_next_script(self):
        ...
        specific_path = Path(r"C:\Users\maruk\carfac-SAI\python\src\carfac\session_1_tone_recognition\tone_recognition_melspectrogram_two_syllabus.py")
        
        # 2. Check relative locations (fallback)
        script_dir = Path(__file__).parent.resolve()
        filename = "tone_recognition_melspectrogram_two_syllabus.py"

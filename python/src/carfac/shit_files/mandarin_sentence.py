...
class DualSAIWithRecording:
    ...
    def _load_audio_file(self):
        ...
        self.set_reference_text('女人去买书')         # For comparison
        self.set_pronunciation_guide('Nǚ rén qù mǎi shū')   # For display
        self.set_translated_text('The woman goes to buy books.')   # For display

...
class DualSAIWithRecording:
    ...
    def _load_audio_file(self):
        ...
        self.set_reference_text('书')         # For comparison
        self.set_pronunciation_guide('shū')   # For display
        self.set_translated_text('book')   # For display
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        default_audio = os.path.join(script_dir, 'reference', 'mandarin_shu.mp3')

...
class DualSAIWithRecording:
    ...
    def _load_audio_file(self):
        ...
        self.set_reference_text('去')         # For comparison
        self.set_pronunciation_guide('qù')   # For display
        self.set_translated_text('to go')   # For display
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        default_audio = os.path.join(script_dir, 'reference', 'mandarin_qu.mp3')

    ...
    def update_visualization(self, frame):
        ...
        try:
            ...
            if self.score_history:
                ...
                score_summary += f"Avg: {np.mean(self.score_history):.1f}%"
...
def main():
    ...
    parser.add_argument('--audio-file', default=r'C:\Users\maruk\Downloads\Python310\carfac-SAI\python\src\reference\mandarin_ma.mp3', 
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        sys.argv.append(r'C:\Users\maruk\Downloads\Python310\carfac-SAI\python\src\reference\mandarin_ma.mp3')
    sys.exit(main() or 0)
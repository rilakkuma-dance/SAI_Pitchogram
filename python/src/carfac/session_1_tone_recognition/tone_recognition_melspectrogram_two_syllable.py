...
class ToneSpectrogramQuiz:
    ...
    def _find_audio_folder(self):
        ...
        paths = [script_dir / 'mandarin_audio_two_syllable', script_dir.parent / 'mandarin_audio_two_syllable']
        for p in paths:
    ...
    def _select_random_item(self):
        ...
        self.status_text.set_text('Click "Show Melspectrogram" to begin.')

...
class TonePlayer:
    ...
    def _launch_next_script(self):
        ...
        possible_locations = [
            ...
            script_dir / 'understanding_tone_SAI.py',
            
            # Parent directory
            script_dir.parent / 'understanding_tone_SAI.py',
            
            # Specific carfac location
            script_dir.parent.parent.parent / 'src' / 'carfac' / 'understanding_tone_SAI.py',
            
            # Current working directory
            Path.cwd() / 'understanding_tone_SAI.py',
        ]

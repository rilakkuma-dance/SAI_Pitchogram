...
class DualSAIWithRecording:
    ...
    def _load_audio_file(self):
        ...
        self.set_reference_text('หู')         # For comparison
        self.set_pronunciation_guide('hǔu')   # For display
        self.set_translated_text('ear')   # For display
...
def main():
    ...
    parser.add_argument('--audio-file', default='reference/thai_huu.mp3', 
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        default_audio = os.path.join(script_dir, 'reference', 'thai_huu.mp3')

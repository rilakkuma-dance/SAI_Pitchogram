...
class WhisperHandler:
    ...
    def transcribe_audio(self, audio_data, language='th'):
    ...
    def transcribe_once(self, audio_data, language='th'):
...
class DualSAIWithRecording:
    ...
    def _load_audio_file(self):
        ...
        self.set_reference_text('ม้ากินข้าว')         # For comparison
        self.set_pronunciation_guide('(Máa kin khâao) meaning: The horse eats rice')   # For display
...
def main():
    ...
    parser.add_argument('--audio-file', default='reference/thai_sentence.wav', 
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        default_audio = os.path.join(script_dir, 'reference', 'thai_sentence.wav')

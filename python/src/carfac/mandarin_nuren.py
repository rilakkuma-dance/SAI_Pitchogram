...
class DualSAIWithRecording:
    ...
    def _load_audio_file(self):
        ...
        self.set_reference_text('女人')         # For comparison
        self.set_pronunciation_guide('nǚrén')   # For display
        self.set_translated_text('woman')   # For display
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        default_audio = os.path.join(script_dir, 'reference', 'mandarin_nuren.mp3')

...
class SimpleAudioVisualizerWithSAI:
    ...
    def next_practice_item(self, event=None):
        ...
        if next_item:
            ...
            print(f"Completed Set #{self.practice_set.set_number}. Switching to 2-syllabus...")
    ...
    def _launch_next_script(self):
        ...
        specific_path = Path(r"C:\Users\maruk\carfac-SAI\python\src\carfac\audio_only_two_syllabus.py")
        
        script_dir = Path(__file__).parent.resolve()
        filename = "audio_only_two_syllabus.py"
...
if __name__ == "__main__":
    ...
    audio_ref_dir = script_dir / "mandarin_audio_one_syllabus"  # reference folder in same directory as script

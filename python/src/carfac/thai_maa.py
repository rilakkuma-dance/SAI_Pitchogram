...
class DualSAIWithRecording:
    ...
    def _load_audio_file(self):
        ...
        self.set_reference_text('ม้า')         # For comparison
        self.set_pronunciation_guide('máa')   # For display
        self.set_translated_text('horse')   # For display
...
def main():
    ...
    parser.add_argument('--audio-file', default='reference/thai_maa.mp3', 
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        default_audio = os.path.join(script_dir, 'reference', 'thai_maa.mp3')
